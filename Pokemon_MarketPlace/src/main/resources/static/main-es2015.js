...
/* harmony import */ var _rsocket_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../rsocket-service */ "Ua0N");
...
class PokeItemsComponent {
    ...
    ngOnInit() {
        if (this.service.rsocket !== undefined)
            ...
            this.service.socketReady.subscribe(b => this.getItem());
    }
}
PokeItemsComponent.ɵfac = function PokeItemsComponent_Factory(t) { return new (t || PokeItemsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_rsocket_service__WEBPACK_IMPORTED_MODULE_2__["RSocketService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_cart_service__WEBPACK_IMPORTED_MODULE_3__["CartService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](PokeItemsComponent, [{
    ...
    }], function () { return [{ type: _rsocket_service__WEBPACK_IMPORTED_MODULE_2__["RSocketService"] }, { type: _cart_service__WEBPACK_IMPORTED_MODULE_3__["CartService"] }]; }, null); })();
...
class PokeListComponent {
    ...
    ngOnInit() {
        if (this.service.rsocket !== undefined)
            ...
            this.service.socketReady.subscribe(b => this.getPokemon());
    }
    // filter function
    check(poke) {
        if (this.name === '') {
...
PokeListComponent.ɵfac = function PokeListComponent_Factory(t) { return new (t || PokeListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_rsocket_service__WEBPACK_IMPORTED_MODULE_2__["RSocketService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_cart_service__WEBPACK_IMPORTED_MODULE_3__["CartService"])); };
...
class ShinyListComponent extends _poke_list_poke_list_component__WEBPACK_IMPORTED_MODULE_1__["PokeListComponent"] {
    ...
    ngOnInit() {
        if (this.service.rsocket !== undefined)
            ...
            this.service.socketReady.subscribe(b => { console.log("sub"); this.getShinyPokemon(); });
    }
    setPrice() {
        for (const i of this.pokemon) {
            if (i.name === 'Arceus') {
